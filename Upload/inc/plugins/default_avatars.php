...
function default_avatars_render_gallery()
{
    ...
    $css = '<style>.default-avatars-wrap{padding:12px}.default-avatars-controls{display:flex;align-items:center;gap:10px;margin-bottom:12px;flex-wrap:wrap}.default-avatars-category-label{font-weight:bold}.default-avatars-category{width:100%;max-width:360px;min-height:34px;padding:6px 28px 6px 10px;border:1px solid #3578b9;border-radius:4px;background-color:#fff;color:#222;font-weight:bold;box-shadow:0 0 0 2px rgba(53,120,185,.16)}.default-avatars-category:focus{outline:2px solid #3578b9;outline-offset:1px}.default-avatars-panel{max-height:260px;overflow:auto;border:1px solid #555;padding:12px}.default-avatars-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(112px,1fr));gap:12px}.default-avatar-option{display:flex;position:relative;flex-direction:column;align-items:center;gap:6px;min-height:142px;padding:8px;border:2px solid transparent;border-radius:4px;cursor:pointer;text-align:center}.default-avatar-option.default-avatar-selected{border-color:#3578b9;background:rgba(53,120,185,.08)}.default-avatar-option input{position:absolute;opacity:0}.default-avatar-option:focus-within{outline:2px solid #3578b9;outline-offset:2px}.default-avatar-preview{display:flex;align-items:center;justify-content:center;width:100px;height:100px}.default-avatar-preview img{max-width:100px;max-height:100px}.default-avatar-name{display:block;line-height:1.3}</style>';
